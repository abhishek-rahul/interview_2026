...
public class PercentSplitPolicy implements SplitPolicy {
    @Override public void validate(long totalPaise, String payerId, List<SplitInput> inputs) { /* TODO */ }
    @Override public List<SplitLine> compute(long totalPaise, String payerId, List<SplitInput> inputs) { return null; }
}
